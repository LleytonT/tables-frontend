      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="flex flex-col justify-center items-center h-screen">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 text-center">
            The Community For Creators
          </h1>
          <div style={{ width: "50%" }}>
            <Box
              component="section"
              sx={{ p: 2, border: "2px dashed blue", borderRadius: 8 }}
            >
              <Typewriter
                options={{ loop: true }}
                onInit={(typewriter) => {
            ...
            <p className="text-base md:text-lg mt-4 mb-8 text-center">
              Say goodbye to endless searching and hello to finding the perfect
              match. Tables has an AI-powered search engine to connect you to
              the community and projects that matter to you.
            </p>
          </div>
